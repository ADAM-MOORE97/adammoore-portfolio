...
function App() {
  ...
  return (
    <div className="App">
      ...
      <br></br>
      <p>As a recent graduate of this software engineering course, I am eager to learn more about other frameworks and languages as well as sharpen the skills that I gained as a result of the course. If you are looking for a passionate, focused, and efficient full-stack engineer that is eager to take on any challenge, then please reach out to me.</p>
      </div>
